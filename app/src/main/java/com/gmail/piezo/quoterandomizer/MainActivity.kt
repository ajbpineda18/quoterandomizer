...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        motivationalButton.setOnClickListener { startRandomQuote("Motivational") }
        businessButton.setOnClickListener { startRandomQuote("Business") }
        gamingButton.setOnClickListener { startRandomQuote("Gaming") }
        favoritesButton.setOnClickListener { startFavoriteSave() }
    }

    private fun startRandomQuote(quoteType: String) {
        val intent = Intent(this, RandomQuote::class.java)
        intent.putExtra("quoteType", quoteType) // Pass the quote type as an extra
